...
(FUNCTION  main  []
  ...
  (BB 4
    ...
    (OPER 11 BEQ []  [(r 8)(i 0)(bb 7)])
  )
  (BB 5
    (OPER 12 Mov [(r 9)]  [(i 3)])
    (OPER 13 Store []  [(r 9)(s a)(i 0)])
  )
  (BB 6
  ...
  (BB 8
    ...
    (OPER 29 Mov [(r 20)]  [(i 8)])
    (OPER 30 LTE [(r 21)]  [(r 5)(r 20)])
    (OPER 31 BNE []  [(r 21)(i 0)(bb 8)])
  )
  (BB 9
    (OPER 32 Mov [(r 22)]  [(i 3)])
    (OPER 33 Div_I [(r 23)]  [(r 3)(r 22)])
    (OPER 34 Mov [(r 4)]  [(r 23)])
    (OPER 35 Mov [(r 24)]  [(i 4)])
    (OPER 36 Mul_I [(r 25)]  [(r 4)(r 24)])
    (OPER 37 Mov [(r 3)]  [(r 25)])
    (OPER 39 Load [(r 26)]  [(s a)(i 0)])
    (OPER 40 Pass []  [(r 1)])
    (OPER 41 Pass []  [(r 26)])
  ...
  (BB 11
    ...
    (OPER 108 BEQ []  [(r 62)(i 0)(bb 14)])
  )
  (BB 12
    (OPER 109 Mov [(r 63)]  [(i 0)])
    (OPER 110 EQ [(r 64)]  [(r 2)(r 63)])
    (OPER 111 BEQ []  [(r 64)(i 0)(bb 17)])
  )
  (BB 15
